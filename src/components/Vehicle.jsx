...
function Vehicle({ vehicle, deleteVehicle, updateLikes, checkWinner }) {
  const renderVehicleImage = (vehicle) => {
    return (
      <img src={vehicle.img} title={vehicle.make} width={220} height={140} />
    );
  };
  return (
    <>
      <div className="card col-md-4">
        ...
        <div className="card-body">
          ...
          <p className="card-text">
            {vehicle.description ? vehicle.description : null}
          </p>
        </div>
        <div className="card-footer">
          {/* note the onClick needs an arrow function as the onclick occurs in the future and not now.. 
                also note React uses camel case for the onClick */}
          <button
            type="button"
            className="btn btn-sm btn-outline-danger"
            onClick={() => updateLikes(vehicle.id, 1)}
          >
            <svg
